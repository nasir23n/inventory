            ...
            <div class="form_row">
                <div class="col_lg_6">
                    <div class="form_group">
                        ...
                        <textarea class="form_control" name="details" rows="5" placeholder="Expense Details"></textarea>
                    </div>
                </div>
            </div> 
            <div class="form_row">
                <div class="col_lg_6">
                    <div class="form_group">
                        ...
                        <input type="number" name="amount" class="form_control" placeholder="Expense Abount" required>
                    </div>
                </div>
            </div> 
            <div class="col_lg_12">
