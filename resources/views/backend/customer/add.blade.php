            ...
            <div class="form_row">
                <div class="col_lg_6">
                    <div class="form_group">
                        ...
                        <input type="text" name="full_name" class="form_control" placeholder="Customer Full Name" required>
                    </div>
                </div>
                <div class="col_lg_6">
                    <div class="form_group">
                        <label>Customer phone <span class="require">*</span></label>
                        <input type="text" name="phone" class="form_control" placeholder="Customer phone" required>
                    </div>
                </div>
                <div class="col_lg_6">
                    <div class="form_group">
                        <label>Customer Email</label>
                        <input type="email" name="email" class="form_control" placeholder="Customer Email">
                    </div>
                </div>
                <div class="col_lg_6">
                    <div class="form_group">
                        <label>Customer address</label>
                        <input type="text" name="address" class="form_control" placeholder="Customer address">
                    </div>
                </div>
                <div class="col_lg_6">
                    <div class="form_group">
